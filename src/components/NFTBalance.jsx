...
function NFTBalance() {
  ...
  const [trans, setTrans] = useState("i will upload");
  ...
  // console.log(form, "merfdd");

  async function upload() {
    const data = image;
    // console.log(data.name, "ogini di");
    // console.log(form.name, "ogini di");
    // console.log(form.description, "ogini di");
    ...
    console.log(txt, "opopopopjbdjsgv87644356");
    setTrans(txt);
  }
  ...
  const handleFormChange = (e) => {
    ...
    const value = e.target.files === null ? e.target.value : e.target.files;
    ...
    <div style={{ padding: "15px", maxWidth: "1030px", width: "100%" }}>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <input
          ...
          id=""
        />
        {/* <input onChange={handleFormChange} type="file" name="image" id="" /> */}
